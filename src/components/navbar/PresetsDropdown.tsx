...
export const PresetsDropdown: React.FC = () => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute left-0 mt-2 w-72 rounded-xl border border-zinc-800 bg-zinc-900/95 p-1.5 shadow-2xl backdrop-blur-md z-50 animate-in fade-in zoom-in-95 duration-150">
          ...
          <div className="space-y-1">
            {AUTOMATA_PRESETS.map(preset => (
              <button
                ...
                className="w-full text-left p-2 rounded-lg hover:bg-zinc-800 transition-colors flex flex-col gap-1 group"
              >
